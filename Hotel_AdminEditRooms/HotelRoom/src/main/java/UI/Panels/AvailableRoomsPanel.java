...
public class AvailableRoomsPanel extends JPanel {
    ...
    public void displayReservationSummary(){
        ...
        System.out.println(CentralRoom.quoteRoom(guest.getGuestID()));


        System.out.println("Difference in days: " + DateProcessor.differenceinDays(start,end));

        BigDecimal days =new BigDecimal( DateProcessor.differenceinDays(start,end));
        BigDecimal totalCost = CentralRoom.quoteRoom(guest.getGuestID());
        ...
        noRooms.setText("<html>Reservation Summary: <br/> Name: "+ guest.getFirstName() + " <br/>Last Name: " + guest.getLastName() +
                ...
                "<br/>Days Staying:" +days + " <br/>Cost Per Night: " + CentralRoom.quoteRoom(guest.getGuestID())+ " <br/> Total Cost: " + totalCost +" </html>");
