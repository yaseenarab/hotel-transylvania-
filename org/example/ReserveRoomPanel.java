...
public class ReserveRoomPanel extends JPanel {
    ...
    private Reservation assignRoom(String hotelType) {
    	...
    	if (("Nature Retreat").equals(hotelType)) {
            System.out.println("STUPID NOOB");
        ...
        System.out.println("KILL HITLER");
    	for (RoomQuality rm : roomOptions) {
            System.out.println("WE PLAY FORTNITE");

        	if (rm.match(roomNeeds)) {
                System.out.println("WE PLAY shitler");
        		boolean conflict = false;
        		try {
                    System.out.println("WE LIKE FORTNITE");
	        		...
	        		if (!conflict) {
                        System.out.println("WE HATE FORTNITE");
	        			return match;
	        		}
