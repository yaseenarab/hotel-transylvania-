...
public class Person {
    ...
    public static final Integer
            NAME_MAX_LENGTH = 16,
            USERNAME_MAX_LENGTH = 16, USERNAME_MIN_LENGTH = 4,
            PASSWORD_MAX_LENGTH = 16, PASSWORD_MIN_LENGTH = 4,
            PHONE_LENGTH = 10;
    private String
            firstName,
            lastName,
    ...
    protected void setLastName (String lastName) throws Exception {
        if(lastName == null) {
            MyLogger.logger.log(Level.SEVERE, "Error in Person.setLastName: lastName is null");
            throw new Exception();
        }
        else if (lastName.isEmpty()) {
            MyLogger.logger.log(Level.SEVERE, "Error in Person.setLastName: lastName is empty");
            throw new Exception();
        }
